...
tk.Button(button_frame, text="Settings", command=start_show_settings).pack(side="left", padx=5)
...
settings_frame.bind("<MouseWheel>", on_mousewheel)

tk.Label(settings_frame, text="Backspace Delay").pack()
backspace_delay_slider = tk.Scale(
    settings_frame, from_=0, to=1, resolution=0.05,
    command=set_backspace_delay, orient="horizontal"
)
backspace_delay_slider.set(0.1)
backspace_delay_slider.pack()

tk.Label(settings_frame, text="Type Delay").pack()
type_delay_slider = tk.Scale(
    settings_frame, from_=0, to=1, resolution=0.05,
    command=set_type_delay, orient="horizontal"
)
type_delay_slider.set(0)
type_delay_slider.pack()

tk.Label(settings_frame, text="Type Speed").pack()
type_speed_slider = tk.Scale(
    settings_frame, from_=0, to=1, resolution=0.05,
    command=set_type_speed, orient="horizontal"
)
type_speed_slider.set(0.9)
type_speed_slider.pack()

tk.Label(settings_frame, text="Delete Speed").pack()
backspace_speed_slider = tk.Scale(
    settings_frame, from_=0, to=1, resolution=0.05,
    command=set_backspace_speed, orient="horizontal"
)
backspace_speed_slider.set(0.9)
backspace_speed_slider.pack()
